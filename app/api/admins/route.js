...
//     });
//   } catch (error) {
//     return new Response(JSON.stringify({ message: 'Error fetching admins', error }), {
//       status: 500,
//       headers: { 'Content-Type': 'application/json' }
//     });
//   }
...
//       return new Response(JSON.stringify({ message: 'Unauthorized to add admin' }), {
//         status: 403,
//         headers: { 'Content-Type': 'application/json' }
//       });
//     }
...
//     });
//   } catch (error) {
//     return new Response(JSON.stringify({ message: 'Error adding admin', error }), {
//       status: 500,
//       headers: { 'Content-Type': 'application/json' }
//     });
//   }
